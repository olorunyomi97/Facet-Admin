...
const CreateCelebrityModal = props => {
    ...
    useEffect(() => {
        ...
        if (notify_success) {
            push_success_notifications('Celebrity successfully created');
            set_modal(false);
        }
    });
        ...
        <div>
            ...
            >
                <Link to="#" className="text-success text-center font-weight-bolder">
                    ...
                    <p>Creating Celebrity</p>
                </Link>
            </div>
            <ModalBody className="modal-contentt" style={{ background: '#1c1c1c' }}>
                <div className="col-md-12">
                    <p className="create-celebs mb-2 mt-2">Create Celebrity</p>
...
export default withRouter(connect(mapStateToProps, { createCelebrity, apiError })(CreateCelebrityModal));
