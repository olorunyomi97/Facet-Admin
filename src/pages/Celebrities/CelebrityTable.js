...
import CelebrityColumn from './CelebrityColumn';
import { isEmpty } from 'lodash';

const CelebrityTable = props => {
    ...
    const rowEvents = {
        onClick: (e, row, rowIndex) => {
            window.location.href = `/celebrity-details/${row._id}`;
        },
    };
    ...
    // 			Object.keys(shipment).some(key =>
    // 				shipment[key].toLowerCase().includes(searchText.toLowerCase())
    // 			)
    // 		)
    // 	)
    // }
                                        ...
                                        <div className="col-md-6">
                                            <div className="search-box me-2 d-inline-block">
                                                <div className="position-relative pt-3 celeb-searchbar">
                                                    ...
                                                    />
                                                    <i className="bx bx-search search-icon pt-3" />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-md-6">
