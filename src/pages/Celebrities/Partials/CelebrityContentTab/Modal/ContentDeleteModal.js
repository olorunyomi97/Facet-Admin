...
const DeleteModal = props => {
    const { deleteContent, modal_loading, error, notify_success, set_modal, user } = props;
    console.log(props)
        ...
        <div>
            ...
            <ModalBody className="modal-contentt" style={{ background: '#1c1c1c' }}>
                <div className="col-md-12">
                    <p className="create-celebs mb-2 mt-2 text-center">Are you sure you want to Delete <span style={{textTransform: 'capitalize', color: '#1fcc79' }}>{user.username}</span> content?</p>
                    <div className="modal-card" style={{ borderRadius: '33px' }}>
                        ...
                        <div className="row login-input-styles">
                            ...
                            <div className="col-md-6">
                                <Link to="#" onClick={() => deleteFanectContent()}>
...
export default withRouter(connect(mapStateToProps, { deleteContent })(DeleteModal));
