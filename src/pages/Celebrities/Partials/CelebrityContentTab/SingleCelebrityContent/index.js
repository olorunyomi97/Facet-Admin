...
const SingleCelebrityContent = props => {
                            ...
                            <div className="card" style={{ borderRadius: '20px' }}>
                            {
                                ...
                                <div className="col-md-6 pt-4" style={{ paddingLeft: '35px' }}>
                                    <div>
                                        ...
                                        <img src={content.data.content_url} width="70%" height="70%" />
                                        {/* <Player
                                            playsInline
...
// export default SingleCelebrityContent;
...
export default withRouter(connect(mapStateToProps, { getContentDetails, apiError, deleteContent })(SingleCelebrityContent));
