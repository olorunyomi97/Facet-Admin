...
const DeleteReportedContentModal = props => {
...
// export default DeleteReportedContentModal;

const mapStateToProps = state => {
    const { error, content, loading } = state.Contents;
    return { error, loading, content };
};
export default withRouter(connect(mapStateToProps, { deleteContent })(DeleteReportedContentModal));
